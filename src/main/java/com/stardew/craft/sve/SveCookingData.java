...
public final class SveCookingData {
    private static final List<Definition> ALL = List.of(
            dish("baked_berry_oatmeal_supreme", 400, 80,
                    ...
                    buffs(buff(BuffType.FARMING, 4, 1_600), buff(BuffType.FORAGING, 4, 1_600),
                            buff(BuffType.SPEED, 2, 1_600)),
            ...
            dish("big_bark_burger", 400, 85,
                    ...
                    buffs(buff(BuffType.SPEED, 1, 480), buff(BuffType.ATTACK, 3, 480)),
                    item("stardewcraftsve:puppyfish"), item("stardewcraft:bread"), item("stardewcraft:oil")),
            dish("flower_cookie", 185, 75,
                    shop("stardewcraftsve:bear_vendor"),
                    buffs(buff(BuffType.LUCK, 2, 800), buff(BuffType.FORAGING, 2, 800),
                            buff(BuffType.SPEED, 2, 800)),
            ...
            dish("frog_legs", 400, 30,
                    ...
                    buffs(buff(BuffType.SPEED, 2, 480), buff(BuffType.DEFENSE, 2, 480)),
                    item("stardewcraftsve:frog"), item("stardewcraft:oil"), item("stardewcraft:wheat_flour")),
            dish("glazed_butterfish", 800, 80,
                    shop("stardewcraft:saloon"),
                    buffs(buff(BuffType.FISHING, 2, 480), buff(BuffType.LUCK, 2, 480)),
            ...
            dish("mixed_berry_pie", 250, 75,
                    shop("stardewcraft:saloon"),
                    buffs(buff(BuffType.FARMING, 3, 1_600), buff(BuffType.MAX_ENERGY, 50, 1_600)),
            ...
            dish("mushroom_berry_rice", 115, 1,
                    shop("stardewcraft:adventure_shop"),
                    buffs(buff(BuffType.MINING, 3, 800), buff(BuffType.MAX_ENERGY, -50, 800),
                            buff(BuffType.MAGNETIC_RADIUS, 32, 800), buff(BuffType.DEFENSE, 3, 800),
                            buff(BuffType.ATTACK, 3, 800)),
            ...
            dish("seaweed_salad", 200, 70,
                    ...
                    buffs(buff(BuffType.FISHING, 1, 900), buff(BuffType.MAX_ENERGY, 30, 900)),
            ...
            dish("void_delight", 800, 1,
                    ...
                    buffs(buff(BuffType.MINING, 2, 600), buff(BuffType.LUCK, 2, 600),
                            buff(BuffType.MAX_ENERGY, 20, 600), buff(BuffType.MAGNETIC_RADIUS, 2, 600),
                            buff(BuffType.SPEED, 2, 600), buff(BuffType.ATTACK, 3, 600)),
            ...
            dish("void_salmon_sushi", 800, 1,
                    shop("stardewcraft:shadow_shop"),
                    buffs(buff(BuffType.FISHING, 3, 1_200), buff(BuffType.LUCK, 3, 1_200),
                            buff(BuffType.MAX_ENERGY, 80, 1_200), buff(BuffType.DEFENSE, 5, 1_200)),
            ...
            dish("candy", 2_000, 50,
                    shop("stardewcraft:saloon"),
                    buffs(buff(BuffType.LUCK, 1, 500), buff(BuffType.MAX_ENERGY, 70, 500),
                            buff(BuffType.SPEED, 1, 500)),
            ...
            dish("ice_cream_sundae", 400, 80,
                    ...
                    buffs(buff(BuffType.MAX_ENERGY, 75, 600), buff(BuffType.SPEED, 1, 600)),
            ...
            dish("prismatic_pop", 2_500, 100,
                    ...
                    buffs(buff(BuffType.MINING, 1, 720), buff(BuffType.LUCK, 3, 720),
                            buff(BuffType.SPEED, 1, 720), buff(BuffType.DEFENSE, 3, 720),
                            buff(BuffType.ATTACK, 3, 720)),
                    item("stardewcraft:prismatic_shard"), tag("c:milk", "stardewcraft:milk"),
                    item("stardewcraft:sugar")),
            dish("fish_dumpling", 100, 45,
                    friendship("olivia", 750), buffs(buff(BuffType.FISHING, 1, 400)),
            ...
            dish("pineapple_custard_crepe", 300, 90,
                    ...
                    buffs(buff(BuffType.LUCK, 3, 500), buff(BuffType.SPEED, 1, 500)),
            ...
            dish("glazed_pear", 400, 100,
                    ...
                    buffs(buff(BuffType.MINING, 2, 700), buff(BuffType.MAGNETIC_RADIUS, 32, 700),
                            buff(BuffType.SPEED, 1, 700), buff(BuffType.DEFENSE, 6, 700)),
                    item("stardewcraftsve:pear"), item("stardewcraft:sugar"),
                    item("stardewcraft:wheat_flour"), item("stardewcraftsve:butter")),
            dish("stuffed_persimmon", 500, 110,
                    friendship("andy", 750), buffs(buff(BuffType.FORAGING, 5, 600)),
            ...
            dish("cheese_charcuterie", 750, 120,
                    friendship("scarlett", 750), buffs(buff(BuffType.FARMING, 4, 400)),
    ...
    private static Buff buff(BuffType type, int level, int sveDuration) {
        return new Buff(type, level, SveConsumableData.durationTicks(sveDuration));
    }
