...
public final class SveBundleAcquisitionCatalog {
    ...
    private static Map<String, String> createRoutes() {
        ...
        route(routes, "minnow", "Fishing and fishing treasure");
        route(routes, "goldfish", "Fishing and fishing treasure");
        route(routes, "tadpole", "Fishing and fishing treasure");
        route(routes, "starfish", "Fishing");
        route(routes, "frog", "Fishing and fishing treasure");
        route(routes, "king_salmon", "Fishing and fishing treasure");
        route(routes, "butterfish", "Fishing and fishing treasure");
        route(routes, "shark", "Fishing and fishing treasure");
        route(routes, "shiny_lunaloo", "Fishing treasure");
        route(routes, "candy", "Saloon recipe; cooking");
        route(routes, "mixed_berry_pie", "Saloon recipe; cooking");
        route(routes, "big_bark_burger", "Saloon recipe; cooking");
        route(routes, "glazed_butterfish", "Saloon recipe; cooking");
